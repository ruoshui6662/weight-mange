...
- 当前进展：已完成最终复审修复：新增 `0005_food_search_key` 前向迁移与索引、PATCH runtime validation、optional nutrient revision upsert；聚焦 2 files/7 tests、全量 28 files/137 tests 和本地门禁均通过，等待复审确认。
